...
public class Bullet : MonoBehaviour
{
    ...
    void PlaySound()
    {
        ...
        if(weaponID != null)AudioSource.PlayClipAtPoint(GameObject.FindGameObjectWithTag("Player").GetComponent<Shooting>().weaponAudioClips[weaponID.Value].clips[Random.Range(0, GameObject.FindGameObjectWithTag("Player").GetComponent<Shooting>().weaponAudioClips[weaponID.Value].clips.Length)], transform.position, 0.66f);
    }
}
